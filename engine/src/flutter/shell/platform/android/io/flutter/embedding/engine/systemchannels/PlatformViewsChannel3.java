 ...
 */
public class PlatformViewsChannel3 {
    private static final String TAG = "PlatformViewsChannel3";
     ...
     */
    public PlatformViewsChannel3(@NonNull DartExecutor dartExecutor) {
        channel =
                new MethodChannel(dartExecutor, "flutter/platform_views_3", StandardMethodCodec.INSTANCE);
     ...
     *
     * <p>To register a {@code PlatformViewsHandler} with a {@link PlatformViewsChannel3}, see {@link
     * PlatformViewsChannel3#setPlatformViewsHandler(PlatformViewsHandler)}.
     */
