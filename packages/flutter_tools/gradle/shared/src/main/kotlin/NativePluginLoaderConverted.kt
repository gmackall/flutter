package com.flutter.gradle.shared

import groovy.json.JsonSlurper
import java.io.File

object NativePluginLoaderConverted {
    // This string must match _kFlutterPluginsHasNativeBuildKey defined in
    // packages/flutter_tools/lib/src/flutter_plugins.dart.
    private const val NATIVE_BUILD_KEY = "native_build"
    private const val FLUTTER_PLUGINS_DEPENDENCIES_FILE = ".flutter-plugins-dependencies"
    ...
    fun getPlugins(flutterSourceDirectory: File): List<Map<String, Any>> {
        ...
        val androidPluginsUntyped =
            (meta["plugins"] as Map<*, *>?)?.get("android")
