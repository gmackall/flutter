...
/// RTL hit-test mirroring repro, run under TLHC + HCPP. This test has no
/// goldens; it asserts that a physical tap on the right does not mirror to the
/// platform view on the left (https://github.com/flutter/flutter/issues/182823).
///
/// For local debugging:
///
/// ```sh
/// flutter drive lib/core/rtl_mirror_main.dart
/// ```
void main() async {
