...
/// Framework-side opacity functionality, run under TLHC + HCPP.
///
/// For local debugging:
///
/// ```sh
/// UPDATE_GOLDENS=1 flutter drive lib/core/opacity_main.dart
/// flutter drive lib/core/opacity_main.dart
/// ```
void main() async {
  const goldenPrefix = 'core_opacity';
