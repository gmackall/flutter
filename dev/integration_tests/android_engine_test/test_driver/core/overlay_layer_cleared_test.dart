...
/// Toggling an overlay texture layer over a platform view clears it, run under
/// TLHC + HCPP.
///
/// For local debugging:
///
/// ```sh
/// UPDATE_GOLDENS=1 flutter drive lib/core/overlay_layer_cleared_main.dart
/// flutter drive lib/core/overlay_layer_cleared_main.dart
/// ```
void main() async {
  const goldenPrefix = 'core_overlay_layer_cleared';
