...
/// Mode-agnostic hide/show/hide functionality, run under each supported [PvMode].
///
/// For local debugging:
///
/// ```sh
/// UPDATE_GOLDENS=1 flutter drive lib/core/hide_show_hide_main.dart
/// flutter drive lib/core/hide_show_hide_main.dart
/// ```
void main() async {
